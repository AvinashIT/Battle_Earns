...
public class Prefab_ConnectWallet : MonoBehaviour
{
    ...
    [Header("States")]
    public GameObject StartScren;
    public GameObject Connected;
    public GameObject Disconected;
    ...
    public async void OnConnect(Wallet _wallet)
    {
        try
        {
            ...
            StartScren.GetComponent<StartScreenScript>().ToggleScreen(Connected,Disconected);
        }
        catch (Exception e)
        {
